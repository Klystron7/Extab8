#!/usr/bin/perl -w -- 
#
# generated by wxGlade 0.9.0b2 on Tue Jan  1 10:21:37 2019
#
...
sub new {
    ...
    $self->{TestLabel} = Wx::StaticText->new($self, wxID_ANY, "Status");
    $self->{label_1} = Wx::StaticText->new($self, wxID_ANY, "Select Output Format:");
    return $self;
...
sub __do_layout {
    ...
    $self->{grid_sizer_2}->Add($self->{label_1}, 1, wxALIGN_CENTER|wxALL, 5);
